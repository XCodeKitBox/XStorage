 ...
 * </p>
 */
public class ExFileProvider extends ContentProvider {
    ...
    @GuardedBy("sCache")
    private static HashMap<String, ExFileProvider.PathStrategy> sCache = new HashMap();
    private String storageRootPath = "storageRootPath";
    private ExFileProvider.PathStrategy mStrategy;
     ...
     *
     * @param context A {@link Context} for the current component.
     * @param authority The authority of a {@link androidx.core.content.FileProvider} defined in a
    ...
    public static Uri getUriForFile(@NonNull Context context, @NonNull String authority,
                                    @NonNull File file) {
        final ExFileProvider.PathStrategy strategy = getPathStrategy(context, authority);
    ...
    /**
     * Return {@link androidx.core.content.FileProvider.PathStrategy} for given authority, either by parsing or
     * returning from cache.
     */
    private static ExFileProvider.PathStrategy getPathStrategy(Context context, String authority) {
        ExFileProvider.PathStrategy strat;
        synchronized (sCache) {
    ...
    /**
     * Parse and return {@link androidx.core.content.FileProvider.PathStrategy} for given authority as defined in
     * {@link #META_DATA_FILE_PROVIDER_PATHS} {@code <meta-data>}.
     *
     * @see #getPathStrategy(Context, String)
     */
    private static ExFileProvider.PathStrategy parsePathStrategy(Context context, String authority)
            throws IOException, XmlPullParserException {
        final ExFileProvider.SimplePathStrategy strat = new ExFileProvider.SimplePathStrategy(authority);
     ...
     *
     * @see androidx.core.content.FileProvider.SimplePathStrategy
     */
     ...
     */
    static class SimplePathStrategy implements ExFileProvider.PathStrategy {
